...
func NewManager(configs []config.CameraConfig, detector *detect.Detector, events chan<- Event, eventEnds chan<- EventEnd, hub *rtsp.Hub, snapshotPath string, snapshotQuality int) *Manager {
	m := &Manager{
